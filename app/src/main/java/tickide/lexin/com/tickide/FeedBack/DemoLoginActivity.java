...
import tickide.lexin.com.tickide.MyApplication;
...
public class DemoLoginActivity extends Activity implements OnClickListener {
    ...
    private TextView appkeyTextView,unreadCountTv;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        appkeyTextView.setText("AppKey:" + MyApplication.DEFAULT_APPKEY);
        //自定义参数演示
        ...
        unreadCountTv = (TextView) findViewById(R.id.unreadCount);
...
//                FeedbackAPI.mFeedbackCustomInfoMap.put("appkey", key);
    ...
    private void openOrGet(final boolean isOpenFeedback) {
        ...
        FeedbackAPI.init(this.getApplication(), MyApplication.DEFAULT_APPKEY);
                        ...
                        public void onSuccess(final int unreadCount) {
                            handler.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if(unreadCount == 0){
                                        unreadCountTv.setText("没有未读信息！");

                                    }else {
                                        unreadCountTv.setText("您有"+unreadCount+"条信息未读！");
                                    }
